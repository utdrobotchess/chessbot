...
/* VERSION DATE DECEMBER 15 / 2012                                         */
/***************************************************************************/

/**** TYPICAL USAGE ****/
// #include "Arduino.h" // including Arduino.h to get access to "millis()"
// #include"TimerUp.h"
...
const long name##OneWeekMs  = (long)(7*24*3600000);\
const long name##OneWeekSec = (long)(7*24*3600);   \
...
{public:
 ...
 long operator=(const _TimerUpInt rightArg)  // overload assignement operator
  { set(rightArg); return rightArg; }
